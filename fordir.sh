...
do
cd /root/script/5_dir/dirsearch ; python3 dirsearch.py  -u http://$line -e * -w dict_mode_dict.txt --timeout=2 --max-retries=1 --plain-text-report=$output/5_dir/$line.txt
