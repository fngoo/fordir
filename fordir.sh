...
echo "python3 dirsearch.py  -u http://$line -e * -w dict_mode_dict.txt -t 50 --timeout=1 --plain-text-report=$output/5_dir/$line.txt" > time.sh ; timeout 360 bash time.sh ; rm time.sh
